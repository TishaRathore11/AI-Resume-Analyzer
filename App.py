...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='tisha@11',db='cv')
...
st.set_page_config(
   page_title="Resume IQ | Smart Resume Analyzer",
...
def load_custom_css():
    ...
    <style>
        ...
        section[data-testid="stSidebar"] {
            background: linear-gradient(180deg, #6C3EF4 0%, #3E1FA0 100%);
        }
        section[data-testid="stSidebar"] * {
        ...
        /* Custom hero header */
        .hero-banner {
            background: linear-gradient(120deg, #6C3EF4 0%, #A084F5 100%);
            padding: 28px 32px;
            border-radius: 18px;
            margin-bottom: 24px;
            box-shadow: 0 8px 24px rgba(108,62,244,0.25);
        }
        .hero-banner h1 {
            color: #ffffff !important;
            margin: 0;
        ...
        .stButton>button, .stFormSubmitButton>button {
            background: linear-gradient(120deg, #6C3EF4, #A084F5);
            color: white;
            border-radius: 10px;
            border: none;
        ...
        .stButton>button:hover, .stFormSubmitButton>button:hover {
            ...
            box-shadow: 0 6px 14px rgba(108,62,244,0.35);
        }

        /* Input fields */
        .stTextInput>div>div>input, .stTextArea textarea {
            border-radius: 10px !important;
            border: 1px solid #d6d2f0 !important;
        }

        /* Progress bar */
        .stProgress > div > div > div > div {
            background: linear-gradient(90deg, #6C3EF4, #ff6b6b) !important;
        }
...
def run():
    ...
    st.markdown('''
        <div class="hero-banner">
            <h1>🌴 Resume IQ</h1>
            <p>Smart resume parsing, scoring & career recommendations — built by Tisha Rathore</p>
        </div>
    ''', unsafe_allow_html=True)
    ...
    link = '<b>Built with 🤍 by <a href="#" style="text-decoration: none; color: #ffffff;">Tisha Rathore</a></b>'
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">Tisha Rathore</a> through 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'tisha@11':
                ...
                st.success("Welcome Tisha ! Total %d " % values + " User's Have Used Our Tool : )")                
